  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed left-0 top-[45%] z-[50] hidden xl:flex items-center gap-3 bg-white border border-primary/20 text-primary py-4 pl-4 pr-5 rounded-r-3xl shadow-[0_10px_40px_rgba(0,52,97,0.15)] group overflow-hidden"
      >
        ...
        <div className="w-10 h-10 rounded-2xl bg-primary/10 flex items-center justify-center group-hover:bg-white/20 transition-colors relative z-10">
          <Navigation className="w-5 h-5 group-hover:text-white transition-colors" />
        </div>
        <div className="relative z-10">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] group-hover:text-white transition-colors leading-none mb-1">Explore</p>
          <p className="text-sm font-headline font-black group-hover:text-white transition-colors leading-none">Branches</p>
        </div>
      </motion.button>
