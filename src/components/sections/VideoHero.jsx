  ...
  return (
    <section className="hero-section relative min-h-[520px] md:min-h-[600px] lg:min-h-[780px] flex items-center overflow-hidden bg-[#0a1628]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 z-10 bg-gradient-to-r from-[#0a1628]/95 via-[#0a1628]/75 to-[#0a1628]/30 pointer-events-none" />
        <div className="absolute inset-0 z-10 bg-gradient-to-t from-[#0a1628]/70 via-transparent to-transparent pointer-events-none" />
        ...
        {!isMobile && (
          <>
            ...
            <video
              ...
              aria-hidden="true"
              className={`absolute inset-0 w-full h-full object-cover object-center transition-opacity duration-700 ${videoFailed ? 'opacity-0' : 'opacity-65'}`}
            />
          </>
        )}
      </div>
